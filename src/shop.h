...
#define TRADE_NOPALADIN		(1 << 7)
#define TRADE_NORANGER		(1 << 8)
#define TRADE_NOWARLOCK		(1 << 9)
#define TRADE_NOCYBORG		(1 << 10)
#define TRADE_NONECROMANCER	(1 << 11)
#define TRADE_NODRUID	  	(1 << 12)
#define TRADE_NOALCHEMIST  	(1 << 13)
#define TRADE_NOBARBARIAN  	(1 << 14)

#define NUM_TRADERS 		15
...
#define WILL_BANK_MONEY		(1 << 2)
#define WILL_NO_CHA		(1 << 4)
...
#define SHOP_IGNORE_CHA(i)	(IS_SET(SHOP_BITVECTOR(i), WILL_NO_CHA))
